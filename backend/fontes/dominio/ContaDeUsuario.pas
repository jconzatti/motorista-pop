...
type
   EPlacaDoCarroInformada = class(ENotSupportedException);
...
//   FPlacaDoCarro := nil;
//   if FMotorista then
//      FPlacaDoCarro := TPlacaDoCarro.Create(pPlacaDoCarro);
//
//   if not FMotorista then
//      if not pPlacaDoCarro.IsEmpty then
//         raise EPlacaDoCarroInformada('Informada placa do carro, mas a conta de usuário não pertence a um motorista!');
//
